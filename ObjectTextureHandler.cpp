...
void loadTextures() {
	readBMPFile(&textures[0], "clover01.bmp");
	setTexture(&textures[0], 9999);


	readBMPFile(&textures[1], "balloon_blue.bmp");
	setTexture(&textures[1], 10000);


	readBMPFile(&textures[2], "brick.bmp");
	setTexture(&textures[2], 10001);


	readBMPFile(&textures[3], "balloon_red.bmp");
	setTexture(&textures[3], 10002);


	readBMPFile(&textures[4], "metal.bmp");
	setTexture(&textures[4], 10003);


	readBMPFile(&textures[5], "wood.bmp");
	setTexture(&textures[5], 10004);


	readBMPFile(&textures[5], "fire.bmp");
	setTexture(&textures[5], 10005);


	readBMPFile(&textures[5], "laser.bmp");
